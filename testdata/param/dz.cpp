...
class CfgWorlds
{
    ...
    class DefaultLighting
    {
        ...
        moonObjectColorFull[]={0.4, 0.4, 0.5, 1};
        moonHaloObjectColorFull[]={0.4, 0.4, 0.5, 0};
        moonsetObjectColor[]={0.5, 0.33, 0.27};
        moonsetHaloObjectColor[]={0.5, 0.33, 0.27};
        nightAngle=5;
        sunSunset=20;
        endSunset=10;
        moonDayIntensity=20.5;
        moonNightIntensity=5.3;
    };
    class DefaultWorld
    {
        class Weather
    ...
    class CAWorld : DefaultWorld
    {
        class Weather : Weather
        {
            class LightingNew
            {
                ...
                class C_Day0
                {
                    ...
                    groundReflectionCloud[]={0.032, 0.0572, 0.096};
                    sky[]={{1.6, 0.99, 0.9}, -1};
                    skyAroundSun[]={{1.5, 0.4211, 0.15}, 0.2};
                ...
                class C_Day4
                {
                    ...
                    bidirect[]={0.03, 0.03, 0.03};
                    bidirectCloud[]={0.03, 0.03, 0.03};
                    ambient[]={{0.12, 0.18, 0.28}, 4};
                    ambientCloud[]={{0.12, 0.18, 0.28}, 4};
                    groundReflection[]={{0.2, 0.23, 0.45}, 1.4};
                    groundReflectionCloud[]={{0.2, 0.23, 0.45}, 1.4};
                    sky[]={{1.6, 0.99, 0.9}, 5};
                    skyAroundSun[]={{1.9, 0.8, 0.3}, 7};
                ...
                class C_Day8
                {
                    ...
                    sunAngle=8;
                    sunOrMoon=1;
                    diffuse[]={{1, 0.604, 0.4}, 10.4};
                    diffuseCloud[]={{1, 0.604, 0.4}, 10.4};
                    bidirect[]={0.03, 0.03, 0.03};
                    bidirectCloud[]={0.03, 0.03, 0.03};
                    ambient[]={{0.12, 0.18, 0.28}, 9.4};
                    ambientCloud[]={{0.12, 0.18, 0.28}, 9.4};
                    groundReflection[]={{0.12, 0.18, 0.28}, 7.4};
                    groundReflectionCloud[]={{0.12, 0.18, 0.28}, 7.4};
                    sky[]={{1.3, 0.99, 0.9}, 10.4};
                    skyAroundSun[]={{1.9, 0.8, 0.3}, 12};
                ...
                class C_Day12
                {
                    ...
                    sunAngle=12;
                    sunOrMoon=1;
                    diffuse[]={{1, 0.64, 0.31}, 11.4};
                    diffuseCloud[]={{1, 0.64, 0.31}, 11.4};
                    bidirect[]={0.03, 0.03, 0.03};
                    bidirectCloud[]={0.03, 0.03, 0.03};
                    ...
                    sky[]={{1.3, 0.99, 0.9}, 10.8};
                    skyAroundSun[]={{1.3, 0.99, 0.9}, 11.4};
                ...
                class C_Day35
                {
                    ...
                    bidirect[]={0.08, 0.08, 0.07};
                    bidirectCloud[]={0.08, 0.08, 0.07};
                    ambient[]={{0.12, 0.18, 0.24}, 11};
                    ambientCloud[]={{0.12, 0.18, 0.24}, 11};
                    groundReflection[]={{0.12, 0.18, 0.24}, 8};
                    groundReflectionCloud[]={{0.12, 0.18, 0.24}, 8};
                    sky[]={{0.7, 0.84, 1}, 11.7};
                    skyAroundSun[]={{1, 1, 1}, 12.5};
                ...
                class O_Nautical1
                {
                    ...
                    skyAroundSun[]={0.05, 0.07, 0.11};
                    desiredLuminanceCoef=0.09;
                ...
                class O_Day8
                {
                    ...
                    sky[]={{1, 1, 1}, 8};
                    skyAroundSun[]={{1, 1, 1}, 8.8};
                    desiredLuminanceCoef=0.27;
                    desiredLuminanceCoefCloud=0.27;
                    EVMin=-2;
                    EVMax=0;
                    filmGrainIntensity=0;
                    spaceIntensity=0;
        ...
        farLightStartLerp=0.65;
        farLightEndLerp=0.05;
...
{
    lightDir[]={0.5, 2, 0.5};
    diffuseColor[]={2.4, 2.4, 2.28, 1};
    ambientColor[]={4.8, 4.8, 5.16, 1};
...
class CfgVehicles
{
    ...
    class Edible_Base : Inventory_Base
    {
        ...
        stackedUnit="g";
        quantityBar=1;
        inventorySlot[]={"DirectCookingA", "DirectCookingB", "DirectCookingC"};
    };
...
class cfgAmmo
{
    ...
    class Explosion_NonLethal : DefaultAmmo
    {
        ...
        soundHit[]={"DZ\sounds\weapons\grenades\hand_grenade_1", 10, 1};
...
class cfgWeapons
{
    ...
    class Rifle_Base : RifleCore
    {
        ...
        soundImpactType="gun";
        boneRemap[]={"bolt", "Weapon_Bolt", "magazine", "Weapon_Magazine", "trigger", "Weapon_Trigger", "charging", "Weapon_Bone_01", "bullet", "Weapon_Bullet", "mag_release", "Weapon_Bone_02", "boltrelease", "Weapon_Bone_03"};
    };
    class BoltActionRifle_Base : Rifle_Base
    {
        ...
        boneRemap[]={"bolthandle", "Weapon_Bolt", "boltbody", "Weapon_Bone_04", "boltbodyS", "Weapon_Bone_05", "trigger", "Weapon_Trigger", "bullet", "Weapon_Bullet", "magazine", "Weapon_Magazine"};
    };
    ...
    class Pistol_Base : PistolCore
    {
        ...
        soundImpactType="gun";
        boneRemap[]={"bolt", "Weapon_Bolt", "magazine", "Weapon_Magazine", "bullet", "Weapon_Bullet", "trigger", "Weapon_Trigger", "hammer", "Weapon_Bone_01"};
    };
